                ...
                <div class="d-flex flex-row">
                    <a href="{{ route('users.show', ['name' => $person->name]) }}">
                        <span class="d-flex align-items-center mr-2" style="text-decoration: none;">
                            ...
                            <img src="{{ asset('https://portfolio-sns-backet.s3.ap-northeast-1.amazonaws.com/avatars/' . $person->avatar_file_name) }}" class="rounded-circle" style="object-fit: cover; width: 55px; height: 55px;">
                            @else
