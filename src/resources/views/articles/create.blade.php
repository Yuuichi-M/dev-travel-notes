                        ...
                        <form method="POST" action="{{ route('articles.store') }}" class="p-3 mb-1" enctype="multipart/form-data">
                            ...
                            <div style="text-align: initial;">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" class="form-control @error('summary') is-invalid @enderror" cols="50" rows="8" name="summary" id="summary" required placeholder="感想を書こう ※10000文字以内">{{ old('summary') }}</textarea>
                                    @error('summary')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>
                                            {{ $message }}
