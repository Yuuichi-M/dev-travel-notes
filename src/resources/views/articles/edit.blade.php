                    ...
                    <div class="card-text">
                        <form method="POST" class="p-3 mb-1" action="{{ route('articles.update',  ['article' => $article]) }}" enctype="multipart/form-data">
                            ...
                            <div style="text-align: initial;">
                                ...
                                <div class="mt-1 mb-3">
                                    <label for="category_id" style="font-size: 16px">
                                        所在地
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" class="form-control @error('summary') is-invalid @enderror" cols="50" rows="8" name="summary" id="summary" required placeholder="感想を書こう ※10000文字以内">{{ $article->summary ?? old('summary') }}</textarea>
                                    @error('summary')
                                    <span class="invalid-feedback" role="alert">
